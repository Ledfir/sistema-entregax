...
const Tarima: React.FC = () => {
  ...
  const handleGuardar = async (values: any) => {
    setSaving(true);
    try {
      await apiClient.post('/cedis-usa/tarima', values);
      message.success('Tarima registrada correctamente');
      form.resetFields();
    } catch (err: any) {
      const msg =
  ...
  return (
    <div style={{ padding: 24, display: 'flex', justifyContent: 'center' }}>
      <Card title="Tarima" style={{ width: '100%', maxWidth: 700 }}>
        <Title
          level={5}
          style={{
            textAlign: 'center',
        ...
        >
          Información necesaria para agregar una tarima
        </Title>
